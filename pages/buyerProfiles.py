    ...
    def filter_data(self):
        try:
            ...
            for buyer in buyers:
                ...
                self.tableWidget.setItem(row, 1, QtWidgets.QTableWidgetItem(str(buyer.buyer_name)))
                self.tableWidget.setItem(row, 2, QtWidgets.QTableWidgetItem(str(buyer.phone)))
                self.tableWidget.setItem(row, 3, QtWidgets.QTableWidgetItem(str(buyer.buyer_rank)))
                self.tableWidget.setItem(row, 4, QtWidgets.QTableWidgetItem(str(buyer.total_payable)))
                self.tableWidget.setItem(row, 5, QtWidgets.QTableWidgetItem(str(buyer.total_paid)))
                self.tableWidget.setItem(row, 6, QtWidgets.QTableWidgetItem(str(buyer.date)))
                self.tableWidget.setItem(row, 7, QtWidgets.QTableWidgetItem(str(buyer.entry_by)))
                ...
                self.tableWidget.setCellWidget(row, 8, view_button)
                ...
                self.tableWidget.setCellWidget(row, 9, delete_button)
                row += 1
