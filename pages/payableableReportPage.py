    ...
    def filter_data(self):
        try:
            ...
            for seller in sellers:
                ...
                self.tableWidget.setItem(row, 4, QtWidgets.QTableWidgetItem(str(seller.total_payable)))  # Price
