...
class BuyerProfileView(QtWidgets.QWidget):
    ...
    def retranslateUi(self):
        try:
            ...
            headers = [
                "ভাউচার নং", "বিক্রেতার নাম", "তারিখ", "মাছের নাম", "মাছের রেট",
                "কাঁচা ওজন", "পাঁকা ওজন", "পরিমান দাম","নাম", "এন্ট্রি বাই"
            ]
    ...
    def filter_data(self):
        try:
            ...
            for buyer in buyers:
                ...
                self.tableWidget.setItem(row, 0, QtWidgets.QTableWidgetItem(str(buyer.vouchar_no)))
                self.tableWidget.setItem(row, 1, QtWidgets.QTableWidgetItem(str(buyer.seller_name)))
                self.tableWidget.setItem(row, 2, QtWidgets.QTableWidgetItem(str(buyer.date)))
                self.tableWidget.setItem(row, 3, QtWidgets.QTableWidgetItem(str(buyer.fish_name)))
                self.tableWidget.setItem(row, 4, QtWidgets.QTableWidgetItem(str(buyer.fish_rate)))
                self.tableWidget.setItem(row, 5, QtWidgets.QTableWidgetItem(str(buyer.raw_weight)))
                self.tableWidget.setItem(row, 6, QtWidgets.QTableWidgetItem(str(buyer.final_weight)))
                self.tableWidget.setItem(row, 7, QtWidgets.QTableWidgetItem(str(buyer.buying_amount)))
                self.tableWidget.setItem(row, 8, QtWidgets.QTableWidgetItem(str(buyer.buyer_name)))
    ...
    def openPrintMemo(self):
        try:
            ...
            self.ui_print_form.ui.tableWidget.horizontalHeader().setMinimumSectionSize(50)
