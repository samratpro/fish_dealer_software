        ...
        try:
            ...
            if buyer_name and fish_name and total_price:
                if total_price.isdigit():
                    ...
                    buyer_item.setFont(self.setting_font)  # Apply font to buyer_name

                    fish_item = QtWidgets.QTableWidgetItem(fish_name)
                    fish_item.setFont(self.setting_font)  # Apply font to fish_name

                    # Add the items with fonts to specific columns
                    self.tableWidget.setItem(row_position, 0, buyer_item)
                    self.tableWidget.setItem(row_position, 1, fish_item)
