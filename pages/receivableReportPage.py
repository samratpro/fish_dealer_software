...
class receivableReport(object):
    ...
    def retranslateUi(self, cashReportMain):
        ...
        item.setText(_translate("cashReportMain", "প্রদান করেছে"))
        ...
        self.nameLabel.setText(_translate("cashReportMain","পাওনা রিপোর্ট"))
        self.printBtn.setText(_translate("cashReportMain", "প্রিন্ট"))


        self.tableWidget.horizontalHeader().setDefaultSectionSize(210)
        self.tableWidget.horizontalHeader().setMinimumSectionSize(210)
    ...
    def apply_bangla_font(self):
        ...
        self.buyerFilterlabel.setFont(custom_font)
    ...
    def update_setting_font(self):
        ...
        self.buyerFilterInput.setFont(custom_font)
        enable_bangla_typing(self.buyerFilterInput, setting.font)
    ...
    def filter_data(self):
        try:
            ...
            session = self.Session()
            query = (
                session.query(BuyerProfileModel)
                .filter(BuyerProfileModel.date.between(start_date, end_date))
                .filter(BuyerProfileModel.buyer_name.ilike(f"%{buyer_filter}%"))
                .filter(BuyerProfileModel.total_payable > 0)  # Add this condition
            )
            buyers = query.all()
            ...
            for buyer in buyers:
                ...
                self.tableWidget.setItem(row, 2, QtWidgets.QTableWidgetItem(str(buyer.total_payable)))  # Seller name
                ...
                self.amount.setText(str(old_amount+custom_int(buyer.total_payable)))
                row += 1

        except Exception as e:
            print(f"Buyer Profile Error in filter_data: {e}")
    ...
    def openPrintMemo(self):
        try:
            ...
            self.ui_print_form.ui.memoLabel.setText("পাওনা রিপোর্ট")
