...
class UI_loanPayingView(object):
    ...
    def retranslateUi(self, cashReportMain):
        ...
        item.setText(_translate("cashReportMain", "এন্ট্রি টাইপ"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("cashReportMain", "নাম"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("cashReportMain", "তারিখ"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("cashReportMain", "টাকা(প্রদান)"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("cashReportMain", "টাকা(গ্রহণ)"))
