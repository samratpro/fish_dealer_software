...
class UI_buyerprofileView(object):
    ...
    def retranslateUi(self, cashReportMain):
        ...
        item.setText(_translate("cashReportMain", "মাছের রেট"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("cashReportMain", "কাঁচা ওজন"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("cashReportMain", "পাঁকা ওজন"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("cashReportMain", "পরিমান দাম"))
