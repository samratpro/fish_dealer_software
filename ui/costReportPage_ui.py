...
class costReport_ui(object):
    def setupUi(self, costExpenseMain):
        ...
        self.nameLabel = QtWidgets.QLabel(parent=self.costExpenseFooter)
        ...
        self.amount = QtWidgets.QLabel(parent=self.costExpenseFooter)
    ...
    def retranslateUi(self, costExpenseMain):
        ...
        item.setText(_translate("costExpenseMain", "ডিলিট"))
        self.nameLabel.setText(_translate("costExpenseMain", "খরচের রিপোর্ট"))
        self.amount.setText(_translate("costExpenseMain", "0"))
