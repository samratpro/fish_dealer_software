...
from pages.settingsPage import Ui_settingsPage
...
class Ui_MainWindow:
    def setupUi(self, MainWindow, username):
        ...
        self.settingsStack.setObjectName("Loan Report Page")
        self.stackedWidget.addWidget(self.settingsStack)
        self.settingsPage = Ui_settingsPage()
        self.settingsPage.setupUi(self.settingsStack)
    ...
    def retranslateUi(self, MainWindow):
        ...
        try:
            ...
            self.userBtn.clicked.connect(lambda: self.switch_page("settings_page"))
    ...
    def switch_page(self, page_name):
        try:
            ...
            #     self.stackedWidget.setCurrentWidget(self.cashReportStack)
                ...
                self.stackedWidget.setCurrentWidget(self.settingsStack)
            else:
