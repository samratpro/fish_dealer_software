...
class Ui_MainWindow:
    def setupUi(self, MainWindow, username):
        ...
        self.stackedWidget.addWidget(self.loanStack)
        ...
        self.stackedWidget.addWidget(self.commissionReportPage)
        ...
        # ************ settings page
        print("debug 13")
        print(f"Username befor settingsPage: {username}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        try:
            ...
            self.loanBtn.clicked.connect(lambda: self.switch_page("loan_page"))
            self.loanIconBtn.clicked.connect(lambda: self.switch_page("loan_page"))

            self.commissionIconBtn.clicked.connect(lambda: self.switch_page("commission_report"))
            self.commissionBtn.clicked.connect(lambda: self.switch_page("commission_report"))

            self.costIconBtn.clicked.connect(lambda: self.switch_page("cost_report"))
            self.costBtn.clicked.connect(lambda: self.switch_page("cost_report"))

            self.settingsBtn.clicked.connect(lambda: self.switch_page("settings_page"))
            self.settingsIconBtn.clicked.connect(lambda: self.switch_page("settings_page"))
            self.userBtn.clicked.connect(lambda: self.switch_page("user_page"))
    ...
    def switch_page(self, page_name):
        try:
            ...
            #     self.stackedWidget.setCurrentWidget(self.cashReportStack)
                ...
                self.stackedWidget.setCurrentWidget(self.loanStack)
            elif page_name == "commission_report":
                self.stackedWidget.setCurrentWidget(self.commissionReportPage)    
            elif page_name == "cost_report":
                self.stackedWidget.setCurrentWidget(self.costreportPage)         
            elif page_name == "settings_page":
                self.stackedWidget.setCurrentWidget(self.settingsPage)
            elif page_name == "user_page":
                self.stackedWidget.setCurrentWidget(self.userPage)
            else:
